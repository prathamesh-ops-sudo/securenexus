...
export const connectors = pgTable(
  "connectors",
  {
    ...
    scheduleReason: text("schedule_reason").notNull().default("auto_sync_off"),
...
export const vulnPackages = pgTable(
  "vuln_packages",
  {
    ...
    packageVendor: text("package_vendor"),
    hostOsId: text("host_os_id"),
    hostOsVersion: text("host_os_version"),
...
export const vulnFindings = pgTable(
  "vuln_findings",
  {
    ...
    findingBasis: text("finding_basis"),
