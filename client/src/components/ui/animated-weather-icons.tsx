  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 py-16">
      <div className="text-center mb-14">
        <h2 className="text-2xl font-bold tracking-tight text-foreground mb-2">Animated Weather Icons</h2>
        <p className="text-sm text-muted-foreground max-w-md mx-auto">
          Each icon is a living micro-scene — rain falls, lightning flashes, sun rays rotate, snowflakes drift. No hover
          required.
        </p>
      </div>
