  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 py-16">
      <div className="text-center mb-14">
        <h2 className="text-2xl font-bold tracking-tight text-foreground mb-2">Animated State Icons</h2>
        <p className="text-sm text-muted-foreground max-w-md mx-auto">
          12 icons that morph between two meaningful states on loop — loading→success, play→pause, lock→unlock. Each
          tells a micro-story.
        </p>
      </div>
