...
export function registerActiveLearningRoutes(app: Express): void {
  ...
  app.post(
    "/api/ai/active-learning/examples",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
  ...
  app.patch(
    "/api/ai/active-learning/examples/:id/deactivate",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.delete(
    "/api/ai/active-learning/examples/:id",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/ai/active-learning/toggle-suppression",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/ai/active-learning/calibrate",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
