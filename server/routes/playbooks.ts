...
export function registerPlaybooksRoutes(app: Express): void {
  ...
  // ─── 24.1 Runbook Execution Tracking ────────────────────────────────────────
  ...
  app.get(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        // List all active trackings for this playbook
        const trackings: any[] = [];
...
<div class="footer">
  ...
  app.get(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        // Aggregate from in-memory tracking
  ...
  // ─── 24.5 Runbook to Playbook Conversion ──────────────────────────────────
