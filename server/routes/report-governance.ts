...
export function registerReportGovernanceRoutes(app: Express): void {
  ...
  app.patch(
    "/api/report-template-versions/:id",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("admin"),
  ...
  app.post(
    "/api/evidence-attachments/:id/presign",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("admin"),
  ...
  app.post(
    "/api/compliance-helpers/run-gap-analysis",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("admin"),
  ...
  app.post(
    "/api/compliance-helpers/run-cross-map",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("admin"),
