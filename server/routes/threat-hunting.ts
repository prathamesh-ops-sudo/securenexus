...
export function registerThreatHuntingRoutes(app: Express): void {
  ...
  app.post(
    "/api/threat-hunting/hunts/:id/execute",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.patch(
    "/api/threat-hunting/schedules/:id/toggle",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.delete(
    "/api/threat-hunting/schedules/:id",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/threat-hunting/pivot/:iocType/:iocValue",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
      ...
      try {
        ...
        const [playbook] = await db
          ...
          .values({
            ...
            estimatedTimeMin:
              typeof estimatedTimeMin === "number" ? Math.max(1, Math.min(480, estimatedTimeMin)) : null,
  ...
  app.delete(
    "/api/threat-hunting/playbooks/:id",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/threat-hunting/results/:id/create-incident",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.patch(
    "/api/threat-hunting/results/:id/link-incident",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.put(
    "/api/threat-hunting/notebooks/:id",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/threat-hunting/notebooks/:id/execute-step",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/threat-hunting/collaborations",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/threat-hunting/collaborations/:id/join",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/threat-hunting/collaborations/:id/message",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/threat-hunting/collaborations/:id/end",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/threat-hunting/hunts/:id/execution-plan",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/threat-hunting/cache/lookup",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.patch(
    "/api/threat-hunting/drifts/:id/acknowledge",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/threat-hunting/hunts/:id/escalate-incident",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/threat-hunting/hunts/:id/to-detection-rule",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/threat-hunting/community/:id/upvote",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
  ...
  app.post(
    "/api/threat-hunting/community/:id/download",
    isAuthenticated,
    resolveOrgContext,
    requireOrgId,
    requireMinRole("analyst"),
