...
export async function seedDatabase() {
  ...
  const [inc1] = await db
    ...
    .values({
      ...
      summary:
        "Multiple failed login attempts from rotating IPs targeting VPN gateway. Pattern consistent with credential stuffing using leaked database.",
      severity: "high",
      status: "open",
      priority: 2,
      confidence: 0.87,
  ...
  const [inc2] = await db
    ...
    .values({
      ...
      summary:
        "Endpoint in finance network segment exhibiting unusual SMB traffic patterns and WMI execution. Possible post-compromise lateral movement.",
      severity: "critical",
  ...
  const [inc3] = await db
    ...
    .values({
      ...
      summary:
        "AWS S3 bucket containing customer PII found publicly accessible. No evidence of unauthorized access yet, but exposure window is approximately 72 hours.",
      severity: "high",
      status: "contained",
      priority: 2,
      confidence: 0.95,
  ...
  const alertData = [
    {
      ...
      description: "PowerShell executing encoded commands on FIN-WKS-042",
      sourceIp: "10.0.15.42",
      ...
      correlationReason: "Same source host, temporal proximity, MITRE chain match",
      detectedAt: new Date(now.getTime() - 4 * 3600000),
      sourceEventId: "cs-evt-20250210-001",
    },
    {
      orgId: org.id,
      source: "CrowdStrike EDR",
      category: "lateral_movement",
      severity: "medium",
      title: "WMI remote execution attempt",
      description: "WMI process creation detected targeting multiple endpoints",
      sourceIp: "10.0.15.42",
      destIp: "10.0.15.50",
      hostname: "FIN-WKS-042",
      ...
      correlationReason: "Same source host, lateral technique",
      detectedAt: new Date(now.getTime() - 3.5 * 3600000),
      sourceEventId: "cs-evt-20250210-002",
    },
    {
      orgId: org.id,
      ...
      category: "lateral_movement",
      severity: "high",
      title: "Anomalous SMB traffic volume",
      description: "10x normal SMB traffic from single source to finance VLAN",
      sourceIp: "10.0.15.42",
      destIp: "10.0.15.0/24",
      mitreTactic: "Lateral Movement",
      ...
      correlationReason: "Same source host, finance segment",
      detectedAt: new Date(now.getTime() - 3 * 3600000),
      sourceEventId: "pa-evt-20250210-001",
    },
    {
      orgId: org.id,
      source: "Splunk SIEM",
      ...
      description: "847 failed VPN login attempts in 15 minutes from distributed IPs",
      ...
      correlationReason: "Distributed source, same target, credential attack pattern",
      detectedAt: new Date(now.getTime() - 6 * 3600000),
      sourceEventId: "splunk-evt-20250210-001",
    },
    {
      orgId: org.id,
      source: "Splunk SIEM",
      category: "credential_access",
      severity: "medium",
      title: "Failed login surge from new geolocation",
      description: "Authentication failures from IPs in Eastern Europe, not seen before",
      sourceIp: "91.234.12.45",
      mitreTactic: "Initial Access",
      mitreTechnique: "T1078",
      status: "correlated",
      incidentId: inc1.id,
      correlationScore: 0.82,
      correlationReason: "Temporal correlation with brute force",
      detectedAt: new Date(now.getTime() - 5.5 * 3600000),
      sourceEventId: "splunk-evt-20250210-002",
    },
    {
      orgId: org.id,
      ...
      severity: "high",
      title: "S3 bucket policy change to public",
      description: "S3 bucket acme-customer-exports-2025 ACL changed to public-read",
      mitreTactic: "Collection",
      mitreTechnique: "T1530",
      status: "correlated",
      incidentId: inc3.id,
      correlationScore: 0.96,
      correlationReason: "Direct causal event for cloud exposure",
      detectedAt: new Date(now.getTime() - 72 * 3600000),
      sourceEventId: "gd-evt-20250207-001",
    },
    {
      orgId: org.id,
      source: "CrowdStrike EDR",
      ...
      description: "New scheduled task detected on marketing workstation",
      sourceIp: "10.0.20.15",
      hostname: "MKT-WKS-007",
      mitreTactic: "Persistence",
      mitreTechnique: "T1053.005",
      status: "new",
      detectedAt: new Date(now.getTime() - 1 * 3600000),
      sourceEventId: "cs-evt-20250210-003",
    },
    {
      orgId: org.id,
      source: "Palo Alto Firewall",
      ...
      description: "Suspicious DNS queries with high entropy subdomain values",
      sourceIp: "10.0.10.88",
      destIp: "8.8.8.8",
      hostname: "DEV-SRV-003",
      mitreTactic: "Exfiltration",
      mitreTechnique: "T1048.003",
      status: "new",
      detectedAt: new Date(now.getTime() - 0.5 * 3600000),
      sourceEventId: "pa-evt-20250210-002",
      protocol: "DNS",
      destPort: 53,
    },
    {
      ...
      description: "User account elevated to domain admin outside change window",
      hostname: "DC-01",
      mitreTactic: "Privilege Escalation",
      mitreTechnique: "T1078.002",
      status: "triaged",
      detectedAt: new Date(now.getTime() - 0.25 * 3600000),
      sourceEventId: "splunk-evt-20250210-003",
    ...
    },
    {
      ...
      description: "IAM user making ListBuckets and GetBucketPolicy calls at unusual hours",
      mitreTactic: "Discovery",
      mitreTechnique: "T1580",
      status: "new",
      detectedAt: new Date(now.getTime() - 2 * 3600000),
      sourceEventId: "gd-evt-20250210-002",
    },
    {
      orgId: org.id,
      source: "CrowdStrike EDR",
      ...
      description: "Known ransomware variant signature found on endpoint",
      sourceIp: "10.0.25.100",
      hostname: "HR-WKS-012",
      fileHash: "a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4",
      mitreTactic: "Execution",
      mitreTechnique: "T1204.002",
      status: "new",
      detectedAt: new Date(now.getTime() - 0.1 * 3600000),
      sourceEventId: "cs-evt-20250210-004",
    },
    {
      orgId: org.id,
      source: "Palo Alto Firewall",
      ...
      status: "dismissed",
      detectedAt: new Date(now.getTime() - 24 * 3600000),
      sourceEventId: "pa-evt-20250209-001",
      analystNotes: "Expected behavior from vulnerability scanner",
    },
  ];
  ...
  await db.insert(incidentComments).values([
    {
      ...
      userId: "sarah.chen",
      userName: "Sarah Chen",
      body: "Confirmed FIN-WKS-042 is compromised. Initial vector was phishing email with malicious Excel macro. Isolating the host now.",
    },
    {
      incidentId: inc2.id,
      userId: "mike.johnson",
      userName: "Mike Johnson",
      body: "Network team has segmented the finance VLAN. No outbound exfiltration detected yet based on DLP logs.",
    },
    {
      incidentId: inc2.id,
      userId: "sarah.chen",
      userName: "Sarah Chen",
      body: "Found persistence mechanism via scheduled task on FIN-WKS-042. Collecting memory dump for forensic analysis.",
    },
    {
      incidentId: inc1.id,
      userId: "alex.wong",
      userName: "Alex Wong",
      body: "Rate limiting enabled on VPN gateway. Attack volume has decreased by 80%. Monitoring for any successful authentications.",
    },
    {
      incidentId: inc3.id,
      userId: "priya.patel",
      userName: "Priya Patel",
      body: "S3 bucket ACL has been restricted. CloudTrail review complete - no evidence of unauthorized data access during exposure window.",
    },
  ]);
  ...
  await db.insert(auditLogs).values([
    {
      ...
      resourceId: inc2.id,
      details: JSON.stringify({ severity: "critical", reason: "Active lateral movement in finance segment" }),
    },
    {
      orgId: org.id,
      userId: "mike.johnson",
      ...
      action: "alert.triage",
      resourceType: "alert",
      resourceId: insertedAlerts[8].id,
      details: JSON.stringify({ newStatus: "triaged", previousStatus: "new" }),
    },
    {
      orgId: org.id,
      userId: "system",
      ...
      resourceType: "incident",
      resourceId: inc2.id,
      details: JSON.stringify({ alertsCorrelated: 3, method: "ai_correlation" }),
    },
    {
      orgId: org.id,
      userId: "priya.patel",
      ...
      resourceType: "incident",
      resourceId: inc3.id,
      details: JSON.stringify({ action: "S3 bucket ACL restricted" }),
    },
    {
      orgId: org.id,
      userId: "alex.wong",
      ...
      resourceType: "alert",
      resourceId: insertedAlerts[11].id,
      details: JSON.stringify({ reason: "Expected vulnerability scanner activity" }),
    },
  ]);
  ...
  await db.insert(connectors).values([
    {
      ...
      lastSyncAt: new Date(now.getTime() - 5 * 60000),
      lastSyncStatus: "success",
      lastSyncAlerts: 3,
      totalAlertsSynced: 247,
    },
    {
      orgId: org.id,
      ...
      status: "active",
      pollingIntervalMin: 3,
      lastSyncAt: new Date(now.getTime() - 3 * 60000),
      lastSyncStatus: "success",
      lastSyncAlerts: 5,
      totalAlertsSynced: 412,
    },
    {
      orgId: org.id,
      ...
      status: "active",
      pollingIntervalMin: 5,
      lastSyncAt: new Date(now.getTime() - 8 * 60000),
      lastSyncStatus: "success",
      lastSyncAlerts: 2,
      totalAlertsSynced: 189,
    },
    {
      orgId: org.id,
      name: "AWS GuardDuty",
      ...
      lastSyncAt: new Date(now.getTime() - 12 * 60000),
      lastSyncStatus: "success",
      lastSyncAlerts: 1,
      totalAlertsSynced: 78,
    },
  ]);
  ...
  await db.insert(integrationConfigs).values([
    {
      ...
      status: "active",
      lastTestedAt: new Date(now.getTime() - 1 * 3600000),
    ...
    },
    {
      ...
      status: "active",
      lastTestedAt: new Date(now.getTime() - 2 * 3600000),
      lastTestStatus: "success",
    },
    {
      orgId: org.id,
      ...
      status: "active",
      lastTestedAt: new Date(now.getTime() - 6 * 3600000),
      lastTestStatus: "success",
    },
  ]);
  ...
  const endpointData = [
    ...
    {
      orgId: org.id,
      hostname: "FIN-WKS-050",
      os: "Windows",
      osVersion: "11 Enterprise 23H2",
      agentVersion: "7.12.0",
      agentStatus: "online",
      ipAddress: "10.0.15.50",
    ...
    },
    {
      ...
      riskScore: 55,
      tags: ["engineering", "server"],
    },
    {
      orgId: org.id,
      hostname: "MKT-WKS-007",
      os: "macOS",
      osVersion: "15.2 Sequoia",
      agentVersion: "7.12.0",
      agentStatus: "online",
  ...
  await db.insert(endpointTelemetry).values([
    {
      orgId: org.id,
      assetId: insertedEndpoints[0].id,
      metricType: "cpu_usage",
      metricValue: { percent: 87, processes: 142 },
    },
    {
      orgId: org.id,
      assetId: insertedEndpoints[0].id,
      metricType: "network_connections",
      metricValue: { active: 34, suspicious: 12 },
    },
    {
      orgId: org.id,
      assetId: insertedEndpoints[3].id,
      metricType: "cpu_usage",
      metricValue: { percent: 42, processes: 89 },
    },
    {
      orgId: org.id,
      assetId: insertedEndpoints[5].id,
      metricType: "disk_usage",
      metricValue: { percent: 78, available_gb: 45 },
    },
  ]);

  // Seed CSPM accounts
  const [cspmAws] = await db
    .insert(cspmAccounts)
    .values([
      {
        orgId: org.id,
        cloudProvider: "aws",
        accountId: "557845624595",
        displayName: "Acme Production (AWS)",
        regions: ["us-east-1", "us-west-2", "eu-west-1"],
        status: "active",
        config: { roleArn: "arn:aws:iam::557845624595:role/CspmReadOnly" },
      ...
      },
      {
        ...
        displayName: "Acme Staging (AWS)",
        regions: ["us-east-1"],
        status: "active",
        config: { roleArn: "arn:aws:iam::123456789012:role/CspmReadOnly" },
  ...
  await db.insert(cspmFindings).values([
    {
      ...
      accountId: cspmAws.id,
      ruleId: "CIS-1.14",
      ruleName: "Ensure access keys are rotated within 90 days",
      severity: "high",
      resourceType: "IAM User",
      resourceId: "arn:aws:iam::557845624595:user/deploy-bot",
      resourceRegion: "global",
      description: "IAM user deploy-bot has access keys older than 90 days",
      remediation: "Rotate access keys for user deploy-bot",
      complianceFrameworks: ["CIS AWS 1.4", "SOC 2"],
      status: "open",
    },
    {
      orgId: org.id,
      ...
      accountId: cspmAws.id,
      ruleId: "CIS-2.1.1",
      ruleName: "Ensure S3 Block Public Access is enabled",
      severity: "critical",
      resourceType: "S3 Bucket",
      resourceId: "acme-customer-exports-2025",
      resourceRegion: "us-east-1",
      description: "S3 bucket does not have Block Public Access enabled at bucket level",
      remediation: "Enable S3 Block Public Access setting on the bucket",
      complianceFrameworks: ["CIS AWS 1.4", "PCI DSS", "SOC 2"],
      status: "remediated",
    },
    {
      orgId: org.id,
      ...
      accountId: cspmAws.id,
      ruleId: "CIS-4.3",
      ruleName: "Ensure VPC flow logging is enabled",
      severity: "medium",
      resourceType: "VPC",
      resourceId: "vpc-0abc123def456789",
      resourceRegion: "us-east-1",
      description: "VPC does not have flow logs enabled",
      remediation: "Enable VPC flow logging to CloudWatch or S3",
    ...
    },
    {
      ...
      accountId: cspmAws.id,
      ruleId: "CIS-2.2.1",
      ruleName: "Ensure EBS volume encryption is enabled by default",
      severity: "high",
      resourceType: "EBS Settings",
      resourceId: "us-east-1",
      resourceRegion: "us-east-1",
      description: "EBS default encryption is not enabled in us-east-1",
      remediation: "Enable default EBS encryption in the region settings",
      complianceFrameworks: ["CIS AWS 1.4", "HIPAA"],
      status: "open",
    },
    {
      orgId: org.id,
      ...
      accountId: cspmAws.id,
      ruleId: "CIS-1.4",
      ruleName: "Ensure no root account access key exists",
      severity: "low",
  ...
  logger
    .child("seed")
    .info(
      "Database seeded: org, 3 incidents, 12 alerts, 10 tags, 4 connectors, 3 integrations, 10 endpoints, 2 CSPM accounts, 5 findings, 6 ingestion logs",
    );
}
